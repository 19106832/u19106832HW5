...
namespace u19106832HW5.Models
{
    public class DataService
    {
        ...
        public List<Book> Search(string name,int type, int author)
        {
            ...
            {
                innerJoin =
                " select books.bookId as ID, books.pagecount as PageCount, books.point as Points, books.name as Name, types.name as Type, " +
                " authors.surname as Author  from Books " +
